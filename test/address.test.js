...
describe('POST /api/contacts/:contactId/addresses', function () {
    ...
    it('should can create new address', async () => {
        ...
        expect(result.body.data.streeet).toBe('jalan test');
        expect(result.body.data.city).toBe('kota test');
        expect(result.body.data.provice).toBe('provinsi test');
...
describe('PUT /api/contacts/:contactId/addresses/:addressId', function () {
    ...
    it('should can update address', async () => {
        ...
        expect(result.body.data.streeet).toBe("street");
        expect(result.body.data.city).toBe("city");
        expect(result.body.data.provice).toBe("provinsi");
        expect(result.body.data.country).toBe("indonesia");
